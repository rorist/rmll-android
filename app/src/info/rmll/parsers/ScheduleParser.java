package info.rmll.parsers;


import info.rmll.exceptions.ParserException;
import info.rmll.listeners.ParserEventListener;
import info.rmll.pojo.Conference;
import info.rmll.pojo.Day;
import info.rmll.pojo.Event;
import info.rmll.pojo.Person;
import info.rmll.pojo.Room;
import info.rmll.pojo.Schedule;
import info.rmll.util.DateUtil;
